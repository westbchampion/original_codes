...
class Dataset(object):
	...
	def prepare(self, class_map=None):
		...
		self.class_from_source_map = {
			"{}.{}".format(info['source'], info['id']): id_
			for info, id_ in zip(self.class_info, self.class_ids)
		}
		self.image_from_source_map = {
			"{}.{}".format(info['source'], info['id']): id_
			for info, id_ in zip(self.image_info, self.image_ids)
		}

		# Mapping from class name to class ID
		self.class_id_from_class_name_map = {
			info['name']: info['id'] for info in self.class_info
		}
	...
	def get_class_id_from_name(self, class_name):
		...
		return self.class_id_from_class_name_map[class_name]
