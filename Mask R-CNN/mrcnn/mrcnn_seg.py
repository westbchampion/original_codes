...
if __name__ == '__main__':
	...
	parser.add_argument(
		'--dataset', required=False, metavar="./mrcnn_data", type=str, default='C://code//test//train_data3',
	...
	parser.add_argument(
		'--subset', required=False, metavar="Dataset sub-directory", type=str, default='C://Users//74550//Desktop//test//test_data',
